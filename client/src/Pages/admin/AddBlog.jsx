import { desc, form, option } from 'motion/react-client'
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <input type="text" placeholder='Type here' required onChange={(e) => settitle(e.target.value)} className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' value={title} />

        <p className='mt-4'>Sub Title</p>
        <input type="text" placeholder='Type here' required onChange={(e) => setsubTitle(e.target.value)} className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' value={subTitle} />
        ...
        <select name="category" onChange={e => setcategory(e.target.value)} className='mt-2 px-3 py-2 border border-gray-300 text-gray-500 outline-none rounded'>
